...
public class PvpServer implements PvpSocket {
    ...
    public void run(int port) {
        try {
            ...
            System.out.println("接收到客户端连接：" + client.getPort());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void send(Pair<ChessPiece, Point> choice) {
        ...
        System.out.println("服务端发出请求：" + request);
        try {
    ...
    public Pair<ChessPiece, Point> receive() {
        ...
        System.out.println("获得客户端响应：" + response);
